...
- C++ projects:
  ...
  - C++ piscine: validated suite of 9 projects made up from severals exercices to learn C++ [OOP (Object-Oriented Programming](https://en.wikipedia.org/wiki/Object-oriented_programming)
...
- Asm projects:
  - libasm: recoded some usual functions, in [assembler](https://en.wikipedia.org/wiki/Assembly_language)
